...
FFMPEG_KIT_TAG="full.v6.0.LTS"
#FFMPEG_KIT_CHECKOUT="origin/develop"
FFMPEG_KIT_CHECKOUT="tags/v6.0.LTS"
...
./ios.sh --full --enable-ios-audiotoolbox --enable-ios-avfoundation --enable-ios-videotoolbox --enable-ios-zlib --enable-ios-bzip2 --no-bitcode --enable-gmp --enable-gnutls -x
echo "Building for tvOS..."
./tvos.sh --full --enable-tvos-audiotoolbox --enable-tvos-videotoolbox --enable-tvos-zlib --enable-tvos-bzip2 --no-bitcode --enable-gmp --enable-gnutls -x
echo "Building for macOS..."
./macos.sh --full --enable-macos-audiotoolbox --enable-macos-avfoundation --enable-macos-bzip2 --enable-macos-videotoolbox --enable-macos-zlib --enable-macos-coreimage --enable-macos-opencl --enable-macos-opengl --enable-gmp --enable-gnutls -x
...
./apple.sh --full --disable-watchos --disable-watchsimulator
